...
class TowerGroup:
    ...
    def upgrade(self):
        ...
        if(self.selected_tower.level<5):                        #當此函數被引用，要是tower的level小於5，tower的level就會加1，反之會一直維持在5
    ...
    def sell(self):
        ...
        self.__towers.remove(self.selected_tower)               #移除選擇中的塔，self.__towers.remove(self.selected_tower) 
        self.selected_tower = None                              #將選擇清空
        self.upgrade_menu = None                                #將upgrade_menu等相關的清空
